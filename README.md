...
7. 主状態の確率40%以上、2位との差10ポイント以上、直近の順位安定、次質問後の1位維持率75%以上を通常判定の条件とする。50%以上は高信頼の目安として扱う
...
状態監査モデルは状態8〜12、質問32〜48を基本とします。少ない回答で主状態・副状態を決めやすくするため、主状態の通常判定条件は40%以上・2位との差10ポイント以上・次質問後の1位維持率75%以上とし、50%以上は高信頼の目安にします。
